...
int main(int argc, char *argv[]) {
    ...
    temp_result = prim_print(l0_make_pair(arena, l0_make_string(arena, "--- Type Checker Test ---"), L0_NIL), env, arena);
    ...
    temp_result = prim_add(l0_make_pair(arena, l0_env_lookup(env, l0_make_symbol(arena, "x")), l0_make_pair(arena, l0_make_integer(arena, 5L), L0_NIL)), env, arena);
    ...
    temp_result = prim_string_append(l0_make_pair(arena, l0_env_lookup(env, l0_make_symbol(arena, "z")), l0_make_pair(arena, l0_make_string(arena, " world"), L0_NIL)), env, arena);
    ...
    { L0_Value* lambda_val = ({ L0_Value* lambda_params = l0_make_pair(arena, l0_make_pair(arena, l0_make_pair(arena, l0_make_symbol(arena, "a"), l0_make_pair(arena, l0_make_symbol(arena, "int"), L0_NIL)), l0_make_pair(arena, l0_make_pair(arena, l0_make_symbol(arena, "b"), l0_make_pair(arena, l0_make_symbol(arena, "int"), L0_NIL)), L0_NIL)), l0_make_pair(arena, l0_make_symbol(arena, "int"), L0_NIL)); L0_Value* lambda_body = l0_make_pair(arena, l0_make_pair(arena, l0_make_symbol(arena, "+"), l0_make_pair(arena, l0_make_symbol(arena, "a"), l0_make_pair(arena, l0_make_symbol(arena, "b"), L0_NIL))), L0_NIL); l0_make_closure(arena, lambda_params, lambda_body, env); }); if (lambda_val != NULL) { (void)l0_env_define(env, l0_make_symbol(arena, "add"), lambda_val); } else { /* Lambda creation failed */ } }
    temp_result = L0_NIL; // Define returns NIL
    ...
    { L0_Value* lambda_val = ({ L0_Value* lambda_params = l0_make_pair(arena, l0_make_pair(arena, l0_make_pair(arena, l0_make_symbol(arena, "name"), l0_make_pair(arena, l0_make_symbol(arena, "string"), L0_NIL)), L0_NIL), l0_make_pair(arena, l0_make_symbol(arena, "string"), L0_NIL)); L0_Value* lambda_body = l0_make_pair(arena, l0_make_pair(arena, l0_make_symbol(arena, "string-append"), l0_make_pair(arena, l0_make_string(arena, "Hello, "), l0_make_pair(arena, l0_make_symbol(arena, "name"), L0_NIL))), L0_NIL); l0_make_closure(arena, lambda_params, lambda_body, env); }); if (lambda_val != NULL) { (void)l0_env_define(env, l0_make_symbol(arena, "greet"), lambda_val); } else { /* Lambda creation failed */ } }
    temp_result = L0_NIL; // Define returns NIL
    ...
    { L0_Value* lambda_val = ({ L0_Value* lambda_params = l0_make_pair(arena, l0_make_pair(arena, l0_make_pair(arena, l0_make_symbol(arena, "flag"), l0_make_pair(arena, l0_make_symbol(arena, "bool"), L0_NIL)), L0_NIL), l0_make_pair(arena, l0_make_symbol(arena, "int"), L0_NIL)); L0_Value* lambda_body = l0_make_pair(arena, l0_make_pair(arena, l0_make_symbol(arena, "if"), l0_make_pair(arena, l0_make_symbol(arena, "flag"), l0_make_pair(arena, l0_make_integer(arena, 100L), l0_make_pair(arena, l0_make_integer(arena, 200L), L0_NIL)))), L0_NIL); l0_make_closure(arena, lambda_params, lambda_body, env); }); if (lambda_val != NULL) { (void)l0_env_define(env, l0_make_symbol(arena, "check"), lambda_val); } else { /* Lambda creation failed */ } }
    temp_result = L0_NIL; // Define returns NIL
    ...
    temp_result = l0_apply(l0_env_lookup(env, l0_make_symbol(arena, "add")), l0_make_pair(arena, l0_make_integer(arena, 1L), l0_make_pair(arena, l0_make_integer(arena, 2L), L0_NIL)), env, arena);
    ...
    temp_result = l0_apply(l0_env_lookup(env, l0_make_symbol(arena, "greet")), l0_make_pair(arena, l0_make_string(arena, "Alice"), L0_NIL), env, arena);
    ...
    temp_result = l0_apply(l0_env_lookup(env, l0_make_symbol(arena, "check")), l0_make_pair(arena, l0_make_boolean(arena, true), L0_NIL), env, arena);
    ...
    temp_result = ({ L0_Value* cond_val = l0_env_lookup(env, l0_make_symbol(arena, "y")); L0_Value* if_res = L0_NIL; if (L0_IS_TRUTHY(cond_val)) { if_res = l0_env_lookup(env, l0_make_symbol(arena, "x")); } else { if_res = l0_make_integer(arena, 0L); } if_res; });
    ...
    temp_result = ({ L0_Value* cond_val = prim_equal(l0_make_pair(arena, l0_env_lookup(env, l0_make_symbol(arena, "x")), l0_make_pair(arena, l0_make_integer(arena, 10L), L0_NIL)), env, arena); L0_Value* if_res = L0_NIL; if (L0_IS_TRUTHY(cond_val)) { if_res = l0_make_string(arena, "yes"); } else { if_res = l0_make_string(arena, "no"); } if_res; });
    ...
    temp_result = l0_apply(l0_env_lookup(env, l0_make_symbol(arena, "let")), l0_make_pair(arena, /* ERROR: Operator in call must be a symbol */, l0_make_pair(arena, prim_string_append(l0_make_pair(arena, l0_env_lookup(env, l0_make_symbol(arena, "b")), l0_make_pair(arena, prim_symbol_to_string(l0_make_pair(arena, l0_apply(l0_env_lookup(env, l0_make_symbol(arena, "quasiquote")), l0_make_pair(arena, l0_env_lookup(env, l0_make_symbol(arena, "foo")), L0_NIL), env, arena), L0_NIL), env, arena), L0_NIL)), env, arena), L0_NIL)), env, arena);
    ...
    { L0_Value* define_val = l0_apply(l0_env_lookup(env, l0_make_symbol(arena, "ref")), l0_make_pair(arena, l0_env_lookup(env, l0_make_symbol(arena, "x")), L0_NIL), env, arena); if (define_val != NULL && l0_parser_error_status == L0_PARSE_OK) { (void)l0_env_define(env, l0_make_symbol(arena, "r"), define_val); } else { /* Value evaluation failed */ } }
    temp_result = L0_NIL; // Define returns NIL
    ...
    temp_result = l0_apply(l0_env_lookup(env, l0_make_symbol(arena, "deref")), l0_make_pair(arena, l0_env_lookup(env, l0_make_symbol(arena, "r")), L0_NIL), env, arena);
    ...
    temp_result = prim_add(l0_make_pair(arena, l0_apply(l0_env_lookup(env, l0_make_symbol(arena, "deref")), l0_make_pair(arena, l0_env_lookup(env, l0_make_symbol(arena, "r")), L0_NIL), env, arena), l0_make_pair(arena, l0_make_integer(arena, 5L), L0_NIL)), env, arena);
    ...
    { L0_Value* lambda_val = ({ L0_Value* lambda_params = l0_make_pair(arena, l0_make_pair(arena, l0_make_pair(arena, l0_make_symbol(arena, "rp"), l0_make_pair(arena, l0_make_pair(arena, l0_make_symbol(arena, "ref"), l0_make_pair(arena, l0_make_symbol(arena, "int"), L0_NIL)), L0_NIL)), L0_NIL), l0_make_pair(arena, l0_make_pair(arena, l0_make_symbol(arena, "ref"), l0_make_pair(arena, l0_make_symbol(arena, "int"), L0_NIL)), L0_NIL)); L0_Value* lambda_body = l0_make_pair(arena, l0_make_symbol(arena, "rp"), L0_NIL); l0_make_closure(arena, lambda_params, lambda_body, env); }); if (lambda_val != NULL) { (void)l0_env_define(env, l0_make_symbol(arena, "ok-lambda-param"), lambda_val); } else { /* Lambda creation failed */ } }
    temp_result = L0_NIL; // Define returns NIL
    ...
    { L0_Value* define_val = l0_apply(l0_env_lookup(env, l0_make_symbol(arena, "ref")), l0_make_pair(arena, l0_env_lookup(env, l0_make_symbol(arena, "x")), L0_NIL), env, arena); if (define_val != NULL && l0_parser_error_status == L0_PARSE_OK) { (void)l0_env_define(env, l0_make_symbol(arena, "r-outer"), define_val); } else { /* Value evaluation failed */ } }
    temp_result = L0_NIL; // Define returns NIL
    ...
    temp_result = l0_apply(l0_env_lookup(env, l0_make_symbol(arena, "ok-lambda-param")), l0_make_pair(arena, l0_env_lookup(env, l0_make_symbol(arena, "r-outer")), L0_NIL), env, arena);
    ...
    temp_result = prim_print(l0_make_pair(arena, l0_make_string(arena, "--- Type Checker Test Complete (Expected errors commented out) ---"), L0_NIL), env, arena);
    ...
    temp_result = l0_apply(l0_env_lookup(env, l0_make_symbol(arena, "quasiquote")), l0_make_pair(arena, l0_env_lookup(env, l0_make_symbol(arena, "test-finished")), L0_NIL), env, arena);
